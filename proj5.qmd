...
```{r}
#| message: false
#| fig-alt: "Faceted bar chart showing traffic stop counts by time of day in NY, OH, and WA; in all states, stops peak around morning to midday and are lowest late at night."
...
```{r}
#| message: false
#| fig-alt: "Grouped bar chart showing traffic stop counts by time of day for NY, OH, and WA; all three states peak in the morning and midday, with WA having the highest counts across most periods."
