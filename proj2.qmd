...
```{r}
#| message: false
#| fig-alt: Bar chart comparing the proportion of Obama’s tweets that include a mention versus those that do not, showing far more tweets without mentions.
mention_summary |>
...
```{r}
#| message: false
#| fig-alt: Horizontal bar chart showing the top usernames mentioned by Obama, with @POTUS mentioned the most, followed by NASA, Pontifex, HillaryClinton, and others in decreasing order.
user_proportions |>
  ggplot(aes(
...
```{r}
#| message: false
#| fig-alt: Bar chart showing the proportion of Obama’s tweets classified as exclamations, questions, both, or neither, with ‘neither’ making up the large majority.
style_data |>
